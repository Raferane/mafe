...
class ZEditOldPasswordTextField extends StatelessWidget {
  ...
  const ZEditOldPasswordTextField({
    super.key,
    ...
    return Obx(
      () => GestureDetector(
        ...
        child: TextFormField(
          ...
          obscureText: editProfileController.isOldPasswordVisible.value,
          ...
          decoration: InputDecoration(
            suffixIcon: IconButton(
              onPressed: () {
                editProfileController.toggleOldPasswordVisibility();
              },
              icon:
                  isEnabled
                      ? Icon(
                        editProfileController.isOldPasswordVisible.value
